...
recipes_meat.json:
	curl "https://api.spoonacular.com/recipes/random?limitLicense=false&tags=meat&number=99&apiKey=498c26d092a94f43be3633099e12f569" | jq '.' > $(TODAY)_recipes_meat.json

recipes_fish.json:
	curl "https://api.spoonacular.com/recipes/random?limitLicense=false&tags=fish&number=99&apiKey=498c26d092a94f43be3633099e12f569" | jq '.' > $(TODAY)_recipes_fish.json

recipes_chicken.json:
	curl "https://api.spoonacular.com/recipes/random?limitLicense=false&tags=chicken&number=99&apiKey=498c26d092a94f43be3633099e12f569" | jq '.' > $(TODAY)_recipes_chicken.json

recipes_dessert.json:
	curl "https://api.spoonacular.com/recipes/random?limitLicense=false&tags=dessert&number=99&apiKey=498c26d092a94f43be3633099e12f569" | jq '.' > $(TODAY)_recipes_dessert.json
